...
public class CrazyDotsRenderer02 implements GLSurfaceView.Renderer {
...
//    private Player currentPlayer;
    ...
    public CrazyDotsRenderer02(final Context context, final int playMode, int rows, int cols, int numPlayers) {
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        positionRectLineInScene(0, 0, 0);
        textureProgram.useProgram();
        rectLine.bindData(draggingLineX1, draggingLineY1, draggingLineX2, draggingLineY2);
        switch (playMode) {
            case PLAY_MODE_SINGLE:
