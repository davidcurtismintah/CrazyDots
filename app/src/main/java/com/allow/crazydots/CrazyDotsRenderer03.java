...
//
//public class CrazyDotsRenderer03 implements GLSurfaceView.Renderer {
//
...
//
//    public CrazyDotsRenderer03(final Context context, final int playMode, int rows, int cols, int numPlayers) {
