...
public class CrazyDotsRenderer01 implements GLSurfaceView.Renderer {
    ...
    private int playerComputerTexture;
...
//    private Player currentPlayer;
    ...
    public CrazyDotsRenderer01(final Context context, final int playMode, int rows, int cols) {
    ...
    public void resetGame(int mode, int numRows, int numCols) {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        playerComputerTexture = TextureHelper.loadTexture(context, R.drawable.player_computer);
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < linesArray.size(); i++) {
            ...
            rectLine.bindData(lineData.line.point1.x, lineData.line.point1.y,
                    lineData.line.point2.x, lineData.line.point2.y, dot.size);
        ...
        positionRectLineInScene(0, 0, 0);
        textureProgram.useProgram();
        rectLine.bindData(draggingLineX1, draggingLineY1, draggingLineX2, draggingLineY2, dot.size / 2);
                ...
                if (gameBoard[row][col] != 0) {
                    if (playMode == PLAY_MODE_SINGLE) {
                        if (gameBoard[row][col] == 1) {
                            ...
                            textureProgram.setUniforms(modelViewProjectionMatrix, playerComputerTexture);
                        } else {
                            playerDot.bindData(textureProgram);
