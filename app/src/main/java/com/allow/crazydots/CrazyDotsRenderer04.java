...
//
//public class CrazyDotsRenderer04 implements GLSurfaceView.Renderer, Handler.Callback {
//
...
//
//    public CrazyDotsRenderer04(final Context context, final int playMode, int rows, int cols, int numPlayers, WifiP2pInfo info) {
